...
import { convertApiCloseTimeToDisplayTime } from '@/utils/operatingHours.js';
    ...
    <CardShell className="flex flex-col px-7 py-8">
      ...
      <ul className="mt-6 flex flex-col gap-4">
        {hours.map(({ day, isOpen, startTime, endTime }) => {
          const displayEndTime = convertApiCloseTimeToDisplayTime(endTime);
          ...
          return (
            ...
            >
              ...
              <span className="text-right">
                {isOpen ? `${startTime} - ${displayEndTime}` : '휴무'}
              </span>
            </li>
          );
        })}
